...
//     <div>
//        <head>
//         <title>Easy-to-Use Interior Designing Cost Calculator | Home Estimator		</title>
//         <meta
//           name="description"
//           content="Calculate your interior design costs in minutes! Our easy-to-use interior designing cost calculator helps you estimate and plan your project effectively.	"
//         />
//         <link rel="canonical" href="https://hcinterior.in/estimator-for-home" />	
//       </head>
//       <MainLayout>
//         <main>
//           {warningMessage && (
...
//             {step < 3 && (
//               <button
//                 className="know_more ms-auto me-5   "
//                 onClick={handleNext}
//               >
...
async function getSeoData() {
  try {
    ...
    // Match the specific page URL for Estimator
...
export default function Estimater() {
  return (
    <MainLayout>
      {/* Client Component handling the interactive steps */}
      <EstimatorClient />
    </MainLayout>
  );
}